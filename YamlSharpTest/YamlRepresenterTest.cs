...
namespace YamlSharpTest
{
    ...
    public class YamlRepresenterTest : YamlTestFixture
    {
        ...
        public void TestScalarsNotPrimitive()
        {
            ...
            Assert.AreEqual(
                BuildResult("!YamlSharpTest.YamlRepresenterTest%2BTestEnum abc"),
                YamlSerializer.Serialize(TestEnum.abc));
            Assert.AreEqual(
                BuildResult("!YamlSharpTest.YamlRepresenterTest%2BTestEnum あいう"),
                YamlSerializer.Serialize(TestEnum.あいう));
            Assert.AreEqual(
                BuildResult("!System.Object {}"),
                YamlSerializer.Serialize(new object()));
            Assert.AreEqual(
                BuildResult("!YamlSharpTest.YamlRepresenterTest%2BTestEnum abc, あいう"),
        ...
        public void TestArray1()
        {
            ...
            Assert.AreEqual(
                BuildResult(
                    ...
                    "- null",
                    "- !System.Decimal 1",
                    "- !YamlSharpTest.YamlRepresenterTest%2BTestEnum abc",
                    "- !YamlSharpTest.YamlRepresenterTest%2BTestEnum あいう",
                    "- \"null\"",
                    "- \"1\"",
                    "- \"-1\"",
                    "- \"-1.0E12\"",
        ...
        public void TestClass()
        {
            ...
            Assert.AreEqual(
                BuildResult(
                "!YamlSharpTest.YamlRepresenterTest%2BTestClass2",
                "Items: ",
                "  Capacity: 0"
                ),
